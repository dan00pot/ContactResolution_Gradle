...
//			selenium.clickElement(androidClientDriver, androidClient.CONTACTS_DETAIL_PREFERENCES);
	...
	public void verifyContactNameCommingCallBeforeAccept(AndroidDriver androidClientDriver, String Expected) throws Exception{
		try {
			Thread.sleep(1000);
			String s = selenium.getAttribute(androidClientDriver, androidClient.INCOMING_CALL_NAME_BEFORE_ACCEPT, "text");
	...
	public void verifyContactNameOutgoingCall(AndroidDriver androidClientDriver, String Expected) throws Exception{
		try {
			Thread.sleep(1000);
	...
	public void navigateToHistoryTab(AndroidDriver androidClientDriver) throws Exception{
		logger.info("navigateToHistoryTab - starting...\n");
		try {
			
			selenium.clickElement(androidClientDriver, androidClient.FIRST_SCREEN_MENU_BTN);
			selenium.clickElement(androidClientDriver, androidClient.firstScreenMenuTabLocators("History"));
			Thread.sleep(2000);
		} catch (Exception exception) {
			logger.error("navigateToHistoryTab - Failed with Exception: " + exception + "...\n");
			throw new Exception("navigateToHistoryTab - Failed - Exception occurs: " + exception);
		}
		logger.info("navigateToHistoryTab - completed...\n");			
    }
	
	public void deleteAllHistory(AndroidDriver androidClientDriver) throws Exception{
		logger.info("deleteAllHistory - starting...\n");
		try {
			Thread.sleep(5000);
			navigateToHistoryTab(androidClientDriver);
				Thread.sleep(3000);
				if(selenium.isElementExisted(androidClientDriver, androidClient.TITLE_BTN))
				{
					selenium.clickElement(androidClientDriver, androidClient.TITLE_BTN);
					Thread.sleep(2000);
					selenium.clickElement(androidClientDriver, androidClient.HISTORY_DETAILS_SCREEN_DELETE_HISTORY_TITLE);
					Thread.sleep(2000);
					selenium.clickElement(androidClientDriver, androidClient.HISTORY_DETAILS_SCREEN_DELETE_HISTORY_CONFIRM_BTN);
					Thread.sleep(2000);
				}
	...
	public void verifyContactNameCallHistory(AndroidDriver androidClientDriver,String no, String expected) throws Exception{
		logger.info("deleteAllHistory - starting...\n");
		try {
			Thread.sleep(5000);
			navigateToHistoryTab(androidClientDriver);
			Thread.sleep(3000);
			String s = selenium.getAttribute(androidClientDriver, androidClient.CALL_HISTORY_CONTACT_NAME(no), "text");
				Thread.sleep(3000);
				if(s.contains(expected))
				{
					logger.info("verifyContactNameCallHistory - PASSED!!!\n");
				}else{
					logger.error("verifyContactNameCallHistory - Failed - Contact: " + s);
					throw new Exception("verifyContactNameCallHistory - Failed");
				}	
		} catch (Exception exception) { 
			logger.error("verifyContactNameCallHistory - Failed with Exception: " + exception + "...\n");
			throw new Exception("verifyContactNameCallHistory - Failed - Exception occurs: " + exception);
		}
		logger.info("verifyContactNameCallHistory - completed...\n");		
    }
	...
	public void verifyEnterpriseNumberOfResult(AndroidDriver androidClientDriver, String email, String expected) throws Exception{
		try {
			selenium.inputText(androidClientDriver, androidClient.CONTACT_SCREEN_SEARCH_TXT, email);
			Thread.sleep(10000);
			logger.info("**** verifyEnterpriseNumberOfResult - Get number of result ****");
			String s1 = selenium.getAttribute(androidClientDriver, androidClient.SEARCH_CONTACT_ENTERPRISE_CONTACT_TITLE_BAR,
					"label");
			if(!s1.contains(expected)){
				logger.error("verifyEnterpriseNumberOfResult - FAILED - Expected result didn't exist");
				throw new Exception("verifyEnterpriseNumberOfResult - Expected result didn't exist");
			}

		} catch (Exception e) {
			logger.error("verifyEnterpriseNumberOfResult - Failed with Exception: " + e + "...\n");
			throw new Exception("verifyEnterpriseNumberOfResult - Failed - Exception occurs: " + e);
		}
	}

public void verifyLocalNumberOfResult(AndroidDriver androidClientDriver, String email, String expected) throws Exception{
	try {
		selenium.inputText(androidClientDriver, androidClient.CONTACT_SCREEN_SEARCH_TXT, email);
		Thread.sleep(10000);
		logger.info("**** verifyLocalNumberOfResult - Get number of result ****");
		String s1 = selenium.getAttribute(androidClientDriver, androidClient.SEARCH_CONTACT_LOCAL_CONTACT_TITLE_BAR,
				"label");
		logger.info("**** verifyLocalNumberOfResult - compare with expected ****");
		if(!s1.contains(expected)){
			logger.error("verifyLocalNumberOfResult - FAILED - Expected is: " +expected+" result but actual is: " +s1);
			throw new Exception("verifyLocalNumberOfResult - Expected result didn't exist");
		}

	} catch (Exception e) {
		logger.error("verifyLocalNumberOfResult - Failed with Exception: " + e + "...\n");
		throw new Exception("verifyLocalNumberOfResult - Failed - Exception occurs: " + e);
	}
}

public boolean verifyLocalContactSearchOnACA (AppiumDriver androidClientDriver, String name, String expected ) throws Exception 
{
	logger.info("verifyLocalContactSearchACA - starting...\n");
	...
	try {
		...
		Thread.sleep(10000);
		logger.info("**** verifyLocalContactSearchOnACA - Get number of result ****");
		
		String s1 = selenium.getAttribute(androidClientDriver, androidClient.SEARCH_CONTACT_LOCAL_CONTACT_TITLE_BAR, "text");
		...
		logger.info("verifyLocalContactSearch - Expected result: " + name);
		
		for (int i = 0; i < num; i++) {
			String order = String.valueOf(i + 1);
			String s2 = selenium.getText(androidClientDriver, androidClient.local_result_by_order(order));
