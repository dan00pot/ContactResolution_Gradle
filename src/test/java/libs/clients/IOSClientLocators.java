...
public class IOSClientLocators {
	...
	public By SEARCH_CONTACT_LOCAL_CONTACT_TITLE_BAR = By.xpath("//XCUIElementTypeTable[@name='unifiedSearchResultsTable']/XCUIElementTypeOther[contains(@name,'Contacts')]");
	
	public By SEARCH_RESULT (String Name){
		return By.id(Name);
	}
	public By local_result_by_order(String order){
		return By.xpath("//XCUIElementTypeTable[@name='unifiedSearchResultsTable']/XCUIElementTypeOther[contains(@name,'Contacts')]/following-sibling::XCUIElementTypeCell["+order+"]/XCUIElementTypeStaticText");
	}
...
//		public By SETTING_SCREEN_ACCOUNT_TAB_PHONE_SERVICE_CONNECTED_TXT				=	By.id("com.avaya.android.flare:id/voip_service_connected_as_user");
		...
		public By TABLE = By.xpath("//*[contains(@Id,'unifiedSearchResultsTable')]");
		...
		public By HISTORY_SCREEN_DELETE_ALL_HISTORY = By.id("Delete All History");
		public By HISTORY_SCREEN_OPEN_HISTORY = By.id("History");
		public By HISTORY_SCREEN_DELETE_ALL_HISTORY_CONFIRM = By.xpath("//XCUIElementTypeButton[contains(@name,'Delete All History')]");
		
		public By CALL_HISTORY_CONTACT_NAME (String No){
			return By.id("Recent_"+No);
		}
		
		 public By ACIOS_WD_CALL_BTN_HANGUP = By.id("end_call");
		    public By ACIOS_WD_CALL_BTN_MUTE = By.id("mute_call");
		    public By ACIOS_WD_CALL_BTN_MORE = By.id("more");
		    public By ACIOS_WD_CALL_BTN_START_VIDEO = By.id("video_call");
		    public By ACIOS_WD_CALL_STT_NAME = By.xpath("//XCUIElementTypeOther/XCUIElementTypeStaticText");
		    public By ACIOS_WD_CALL_BTN_ADD = By.id("add");
		    public By ACIOS_WD_CALL_BTN_HOLD_CALL  = By.id("hold");
		    public By ACIOS_WD_CALL_BTN_TRANSFER_CALL = By.id("transfer");
		    public By ACIOS_WD_CALL_BTN_MESSAGE = By.id("message");
			
	    public By DIALPAD_BTN (String number){
	    return By.id("button_"+number);
	    }

	    
	    
		public By ACIOS_WD_POPUP_DIALPAD_BTN_CALL = By.id("Audio call");
		public By ACIOS_WD_CALL_BTN_OPEN_KEYPAD = By.id("dialpadButton");
		
		public By CONVERSATION_SCREEN_SELECT_ALL_BTN = By.id("Select All");
		public By CONVERSATION_SCREEN_COPY_BTN = By.id("Copy");
		public By CONVERSATION_SCREEN_CUT_BTN = By.id("Cut");
		public By CONVERSATION_SCREEN_PASTE_BTN = By.id("Paste");
