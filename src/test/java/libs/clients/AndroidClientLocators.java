...
public class AndroidClientLocators {
	...
	public By CALL_HISTORY_CONTACT_NAME(String No) {
		return By
				.xpath("//android.widget.TextView[@resource-id='com.avaya.android.flare:id/recentsContactName'][@index='"+No+"']");
//		return By
...
//	}
	public By local_result_by_order(String order) {
		return By
				.xpath("//android.widget.FrameLayout[@index='"+order+"']//android.widget.TextView[@resource-id='com.avaya.android.flare:id/contact_item_name']");
	}
