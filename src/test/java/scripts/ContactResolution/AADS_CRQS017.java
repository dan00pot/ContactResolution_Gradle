...
public class AADS_CRQS017 {
	
	/*########################################################################################################
 	Verify that Enterprise  or Equinox contact matching with mid-calls on phone numbers via device clients
	...
	*Note:Notes:
	...
	final static Logger logger = LogManager.getLogger("AADS_CRQS017");
	...
	@Before
	public void beforetestAADS_CRQS017() throws Exception {
		logger.info("Before test - AADS_CRQS017 - starting...\n");
		//webDriver = driverMgnt.createWebDriver();
		...
		logger.info("Before test - AADS_CRQS017 - completed...\n");
	}
	...
	@Test
	public void AADS_CRQS017() throws Exception {
		logger.info("AADS_CRQS017 - starting...\n");
		try {
			for(int i = 0;i<3;i++){
			...
			winClient.oneX_logout(windowsDriverRoot);
			logger.error("AADS_CRQS017 - Failed with Exception:" + exception
					+ "...\n");
			fail("AADS_CRQS017 - Failed - Exception occurs: "
					+ exception.toString());
			assertTrue(false);
		}
		logger.info("AADS_CRQS017 - completed...\n");
	}
