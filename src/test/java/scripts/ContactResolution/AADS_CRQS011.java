...
public class AADS_CRQS011 {
	
	/*########################################################################################################
 	Verify that Enterprise contact matching with mid-calls on phone numbers via device clients
	...
	*Note:Notes:
	...
	final static Logger logger = LogManager.getLogger("AADS_CRQS011");
	...
	@Before
	public void beforetestAADS_CRQS011() throws Exception {
		logger.info("Before test - AADS_CRQS011 - starting...\n");
		...
		logger.info("Before test - AADS_CRQS011 - completed...\n");
	}
	...
	@Test
	public void AADS_CRQS011() throws Exception {
		logger.info("AADS_CRQS011 - starting...\n");
		try {
			for(int i = 0;i<3;i++){
			...
			String expected4 = "EXT, "+ phoneNumber;
			...
			winClient.oneX_logout(windowsDriverRoot);
			logger.error("AADS_CRQS011 - Failed with Exception:" + exception
					+ "...\n");
			fail("AADS_CRQS011 - Failed - Exception occurs: "
					+ exception.toString());
			assertTrue(false);
		}
		logger.info("AADS_CRQS011 - completed...\n");
	}
