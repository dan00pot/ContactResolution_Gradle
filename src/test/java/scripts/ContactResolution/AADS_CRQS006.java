...
public class AADS_CRQS006 {
	...
	*Note:Notes:
	...
	final static Logger logger = LogManager.getLogger("AADS_CRQS006");
	...
	@Before
	public void beforetestAADS_CRQS006() throws Exception {
		...
		logger.info("Before test - AADS_CRQS006 - completed...\n");
	}
	...
	@Test
	public void AADS_CRQS006() throws Exception {
		logger.info("AADS_CRQS006 - starting...\n");
		try {
			for(int i = 0;i<3;i++){
