...
public class AADS_CRQS005 {
	
	/*########################################################################################################
 	Verify that Equinox  contact matching with transfer calls on phone numbers via device clients
 	Verify that Equinox  contact contact matching with call history in case of transfer calls via device clients
	...
	*Procedures:
		...
		2. Checking information E, F, G on A, B, C clients while having transfer calls
		3. Checking information E, F, G on A, B, C clients in history
		
	*Expected result:
		1. information E, F, G show exactly on A, B, C clients while having transfer calls
		2. information E, F, G show exactly on A, B, C in history
	...
	*Note:Notes:
	...
	@Before
	public void beforetestAADS_CRQS005() throws Exception {
		...
		logger.info("Before test - AADS_CRQS005 - completed...\n");
	}
	 ...
	 */
	@Test
	public void AADS_CRQS005() throws Exception {
		logger.info("AADS_CRQS005 - starting...\n");
		try {
			for(int i = 0;i<3;i++){
			...
			winClient.oneX_logout(windowsDriverRoot);
			logger.error("AADS_CRQS005 - Failed with Exception:" + exception
					+ "...\n");
			fail("AADS_CRQS005 - Failed - Exception occurs: "
					+ exception.toString());
			assertTrue(false);
		}
		logger.info("AADS_CRQS005 - completed...\n");
	}
