...
public class AADS_CRQS015 {
	
	/*########################################################################################################
 	Verify that Enterprise  or Equinox contact matching with outcomming calls on phone numbers via device clients
	...
	*Note:Notes:
	...
	final static Logger logger = LogManager.getLogger("AADS_CRQS015");
	...
	@Before
	public void beforetestAADS_CRQS015() throws Exception {
		logger.info("Before test - AADS_CRQS015 - starting...\n");
		...
		logger.info("Before test - AADS_CRQS015 - completed...\n");
	}
	...
	@Test
	public void AADS_CRQS015() throws Exception {
		logger.info("AADS_CRQS015 - starting...\n");
		try {
			...
			winClient.oneX_logout(windowsDriverRoot);
			logger.error("AADS_CRQS015 - Failed with Exception_example:" + exception
					+ "...\n");
			fail("AADS_CRQS015 - Failed - Exception occurs: "
					+ exception.toString());
			assertTrue(false);
		}
		logger.info("AADS_CRQS015 - completed...\n");
	}
