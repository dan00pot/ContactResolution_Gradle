...
public class AADS_CRQS010 {
	
	/*########################################################################################################
 	Verify that Enterprise contact matching with call history in case of outcomming calls via device clients
	...
	*Note:Notes:
	...
	final static Logger logger = LogManager.getLogger("beforetestAADS_CRQS010");
	...
	@Before
	public void beforetestAADS_CRQS010() throws Exception {
		logger.info("Before test - AADS_CRQS010 - starting...\n");
		...
		logger.info("Before test - AADS_CRQS010 - completed...\n");
	}
	...
	@Test
	public void AADS_CRQS010() throws Exception {
		logger.info("AADS_CRQS010 - starting...\n");
		try {
			for(int i=0; i<3; i++){
			...
			winClient.oneX_logout(windowsDriverRoot);
			logger.error("AADS_CRQS010 - Failed with Exception:" + exception
					+ "...\n");
			fail("AADS_CRQS010 - Failed - Exception occurs: "
					+ exception.toString());
			assertTrue(false);
		}
		logger.info("AADS_CRQS010 - completed...\n");
	}
