...
public class AADS_CRQS002 {
	
	/*########################################################################################################
 	Verify that Equinox contact matching with call history in case of incomming calls via device clients
	...
	*Note:Notes:
	...
	final static Logger logger = LogManager.getLogger("AADS_CRQS002");
	String phonepass = "123456";
	String Winium_URL = aadsData.WiniumURL(1);
	String WinApp_URL = aadsData.WinAppURL(1);
	
	@Before
	public void beforetestAADS_CRQS002() throws Exception {
		logger.info("Before test - AADS_CRQS002 - starting...\n");
		...
		logger.info("Before test - AADS_CRQS002 - completed...\n");
	}
	...
	@Test
	public void AADS_CRQS002() throws Exception {
		logger.info("AADS_CRQS002 - starting...\n");
		try {
			for(int i = 0;i<3;i++){
			...
			winClient.oneX_logout(windowsDriverRoot);
			logger.error("AADS_CRQS002 - Failed with Exception:" + exception
					+ "...\n");
			fail("AADS_CRQS002 - Failed - Exception occurs: "
					+ exception.toString());
			assertTrue(false);
		}
		logger.info("AADS_CRQS002 - completed...\n");
	}
