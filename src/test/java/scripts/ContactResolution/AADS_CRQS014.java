...
public class AADS_CRQS014 {

	/*########################################################################################################
 	Verify that Enterprise  or Equinox contact matching with call history in case of incomming calls via device clients
	...
	*Note:Notes:
	...
	final static Logger logger = LogManager.getLogger("AADS_CRQS014");
	...
	@Before
	public void beforetestAADS_CRQS014() throws Exception {
		logger.info("Before test - AADS_CRQS014 - starting...\n");
		...
		logger.info("Before test - AADS_CRQS014 - completed...\n");
	}
	...
	@Test
	public void AADS_CRQS014() throws Exception {
		logger.info("AADS_CRQS014 - starting...\n");
		try {
			for(int i = 0;i<3;i++){
			...
			winClient.oneX_logout(windowsDriverRoot);
			logger.error("AADS_CRQS014 - Failed with Exception:" + exception
					+ "...\n");
			fail("AADS_CRQS014 - Failed - Exception occurs: "
					+ exception.toString());
			assertTrue(false);
		}
		logger.info("AADS_CRQS014 - completed...\n");
	}
