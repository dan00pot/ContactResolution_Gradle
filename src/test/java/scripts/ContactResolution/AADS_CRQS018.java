...
public class AADS_CRQS018 {

	/*########################################################################################################
 	Verify that Enterprise  or Equinox  contact matching  with call history in case of mid-calls via device clients
	...
	*Note:Notes:
	...
	final static Logger logger = LogManager.getLogger("AADS_CRQS018");
	...
	public void AADS_CRQS006() throws Exception {
		...
		try {
			...
			winClient.oneX_transferCall(windowsDriverRoot, aadsData.AADS_USER_3_NAME_SIP_PHONE_CRQS);
			Thread.sleep(5000);
			winClient.verifyCalleeName(windowsDriverRoot, expected2);
