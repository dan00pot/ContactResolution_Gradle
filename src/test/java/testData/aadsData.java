...
//	public String AADS_USER_GROUP = "CN=Users,CN=Builtin,DC=aam1,DC=com";
	...
	public String AADS_USER_0_NAME_SIP_PHONE_CRQS					= "80071";
	public String AADS_USER_1_NAME_SIP_PHONE_CRQS					= "80072";
	public String AADS_USER_2_NAME_SIP_PHONE_CRQS					= "80073";
	public String AADS_USER_3_NAME_SIP_PHONE_CRQS					= "80072";
	public String AADS_USER_3_FULL_NAME_CRQS						= "Kristin Wagner";
	public String AADS_USER_4_NAME_SIP_PHONE_CRQS					= "80071";
	public String AADS_USER_4_FULL_NAME_CRQS						= "Franklyn Rush";
	public String AADS_USER_NAME_H323_PHONE_CRQS					= "73950";
	public String AADS_USER_NAME_H323_PHONE_CRQS_AND_LDAP			= "73960";
	...
	public static String APPIUM_SERVER_ANDROID = excelData.getNetworkData("android", 2, 1);
	public static String APPIUM_PORT_ANDROID = excelData.getNetworkData("android", 3, 1);
	public static String MOBILE_UDID_ANDROID = excelData.getNetworkData("android", 4, 1);
	
	//################################## APPIUM SERVER FOR IOS CLIENT##########################
	public static String APPIUM_SERVER_iOS = excelData.getNetworkData("iOS", 2, 1);
	public static String APPIUM_PORT_iOS = excelData.getNetworkData("iOS", 3, 1);
	public static String MOBILE_UDID_iOS = excelData.getNetworkData("iOS", 4, 1);
